...
test("renders markdown tables links highlighted code image media and long output in the timeline", async ({
  page,
}) => {
  ...
  try {
    ...
    await expectNoDocumentScroll(
      page,
      "markdown/media/code replay should stay inside the fixed shell",
    );
