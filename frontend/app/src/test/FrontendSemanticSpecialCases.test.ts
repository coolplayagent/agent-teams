...
const KNOWN_SEMANTIC_DEBT: Readonly<Record<string, KnownSemanticDebt>> = {
  "features/automation/AutomationView.tsx|Do not branch on provider === \"feishu\".": {
    count: 5,
    reason: "Feishu automation behavior is dispatched from a page instead of a typed provider adapter.",
  },
  "features/boards/BoardTodosView.tsx|Do not branch on provider === \"local\".": {
    count: 1,
    reason: "Board source behavior is coupled to a concrete provider identifier.",
  },
  "features/connectors/ConnectorsView.tsx|Do not branch on provider === \"discord\".": {
    count: 2,
    reason: "Connector presentation is coupled to concrete provider identifiers.",
  },
  "features/connectors/ConnectorsView.tsx|Do not branch on provider === \"feishu\".": {
    count: 1,
    reason: "Connector presentation is coupled to concrete provider identifiers.",
  },
  "features/connectors/ConnectorsView.tsx|Do not branch on provider === \"github\".": {
    count: 3,
    reason: "Connector presentation is coupled to concrete provider identifiers.",
  },
  "features/connectors/ConnectorsView.tsx|Do not branch on provider === \"w3\".": {
    count: 6,
    reason: "Connector presentation is coupled to concrete provider identifiers.",
  },
  "features/connectors/ConnectorsView.tsx|Do not branch on provider === \"wechat\".": {
    count: 1,
    reason: "Connector presentation is coupled to concrete provider identifiers.",
  },
  "features/connectors/ConnectorsView.tsx|Do not branch on provider === \"xiaoluban\".": {
    count: 1,
    reason: "Connector presentation is coupled to concrete provider identifiers.",
  },
  "features/connectors/GatewayConnectorEditor.tsx|Do not branch on provider === \"discord\".": {
    count: 7,
    reason: "Gateway form shape is coupled to a concrete provider identifier.",
  },
  "features/connectors/RuntimeToolsSection.tsx|Do not branch on tool === \"clawhub\".": {
    count: 1,
    reason: "Runtime tool presentation is coupled to a concrete tool name.",
  },
  "features/connectors/RuntimeToolsSection.tsx|Do not branch on tool === \"relay-knowledge\".": {
    count: 1,
    reason: "Runtime tool presentation is coupled to a concrete tool name.",
  },
  "features/settings/RuntimeSettingsSections.tsx|Do not branch on provider === \"claude\".": {
    count: 1,
    reason: "Settings behavior is coupled to a concrete provider identifier.",
  },
  "features/settings/RuntimeSettingsSections.tsx|Do not branch on provider === \"clawhub\".": {
    count: 4,
    reason: "Settings behavior is coupled to a concrete provider identifier.",
  },
  "features/settings/SettingsCenter.tsx|Do not branch on provider === \"codeagent\".": {
    count: 2,
    reason: "Model editor behavior is coupled to a concrete provider identifier.",
  },
  "features/settings/SettingsCenter.tsx|Do not branch on provider === \"maas\".": {
    count: 2,
    reason: "Model editor behavior is coupled to a concrete provider identifier.",
  },
  "features/settings/SettingsCenter.tsx|Do not branch on provider !== \"codeagent\".": {
  ...
  "features/shell/AppShell.tsx|Do not branch on title === \"Subagent\".": {
    count: 1,
    reason: "Subagent identity is inferred from display copy instead of structured state.",
  },
  "features/shell/ObservabilityPanel.tsx|Do not branch on title === \"观测\".": {
    count: 1,
    reason: "Locale is inferred from translated display copy instead of language state.",
  },
  "features/timeline/MessageTimeline.tsx|Do not branch on tool === \"read\".": {
    count: 1,
    reason: "Tool result presentation is coupled to a concrete tool name.",
  },
  "features/timeline/toolPresentation.ts|Do not branch on tool !== \"unknown\".": {
    count: 1,
    reason: "Tool presentation treats a display sentinel as structured tool identity.",
  },
  "features/workspaces/WorkspaceProjectView.tsx|Do not branch on provider === \"local\".": {
    count: 4,
    reason: "Workspace behavior is coupled to concrete transport provider identifiers.",
  },
  "features/workspaces/WorkspaceProjectView.tsx|Do not branch on provider === \"ssh\".": {
    count: 4,
    reason: "Workspace behavior is coupled to concrete transport provider identifiers.",
  },
} as const;
