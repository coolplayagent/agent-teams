...
RUN_EVENT_TYPE_TO_AG_UI_TYPE: dict[RunEventType, AgUiEventType] = {
    ...
    RunEventType.AWAITING_MANUAL_ACTION: AgUiEventType.RUN_AWAITING_MANUAL_ACTION,
    RunEventType.LLM_RETRY_SCHEDULED: AgUiEventType.LLM_RETRY_SCHEDULED,
    RunEventType.LLM_RETRY_EXHAUSTED: AgUiEventType.LLM_RETRY_EXHAUSTED,
    RunEventType.LLM_FALLBACK_ACTIVATED: AgUiEventType.LLM_FALLBACK_ACTIVATED,
    RunEventType.LLM_FALLBACK_EXHAUSTED: AgUiEventType.LLM_FALLBACK_EXHAUSTED,
    RunEventType.STATE_SNAPSHOT: AgUiEventType.STATE_SNAPSHOT,
    RunEventType.STATE_DELTA: AgUiEventType.STATE_DELTA,
    ...
    RunEventType.MODEL_REQUEST_WAITING: AgUiEventType.MODEL_REQUEST_WAITING,
    RunEventType.MODEL_REQUEST_ACQUIRED: AgUiEventType.MODEL_REQUEST_ACQUIRED,
    ...
    RunEventType.RUNTIME_GUARDRAIL_ALERT: AgUiEventType.RUNTIME_GUARDRAIL_ALERT,
    RunEventType.RUNTIME_GUARDRAIL_REPORT: AgUiEventType.RUNTIME_GUARDRAIL_REPORT,
    RunEventType.HOOK_STARTED: AgUiEventType.HOOK_STARTED,
    RunEventType.HOOK_COMPLETED: AgUiEventType.HOOK_COMPLETED,
    RunEventType.HOOK_FAILED: AgUiEventType.HOOK_FAILED,
    RunEventType.HOOK_CONFLICT: AgUiEventType.HOOK_CONFLICT,
    RunEventType.HOOK_DECISION_APPLIED: AgUiEventType.HOOK_DECISION_APPLIED,
    RunEventType.HOOK_DEFERRED: AgUiEventType.HOOK_DEFERRED,
}
