...
def test_environment_cannot_replace_default_computer_runtime(
    tmp_path,
    monkeypatch,
) -> None:
...
def test_scripted_computer_runtime_provides_test_screenshot() -> None:
...
def test_scripted_computer_runtime_uses_explicit_screenshot_path(tmp_path) -> None:
    ...
    runtime = ScriptedComputerRuntime(screenshot_path=screenshot_path)
